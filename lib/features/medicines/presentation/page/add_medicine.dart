  ...
  void initState() {
    ...
    if (widget.medicine != null) {
      ...
      if (widget.medicine.startDate != null &&
          widget.medicine.endDate != null) {
        range = DateTimeRange(
            start: widget.medicine.startDate, end: widget.medicine.endDate);
      }
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<MedicineReminder>>(
                    future: widget.medicine == null
                        ? null
                        : db.getMedicineReminders(widget.medicine.id),
                    builder: (context, snapshot) {
                      if (widget.medicine != null)
                        times = (snapshot.data ?? [])
                            .map((e) => TimeOfDay.fromDateTime(e.date))
                            .toList();
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        'قم بإضافة مواعيد يومية للتنبيه',
                                        style: TextStyle(
                                            color: Colors.black54,
                                            fontSize: 13),
                                      ),
                                      InkWell(
                                        child: Icon(
                                          Icons.add,
                                          color: amount == times.length
                                              ? Colors.grey[500]
                                              : Colors.black,
                                        ),
                                        onTap: amount == times.length
                                            ? null
                                            : () async {
                                                final time =
                ...
                Container(
                  ...
                  child: FutureBuilder<Doctor>(
                      future: widget.medicine == null
                          ? null
                          : db.getDoctor(widget.medicine.doctorId),
                      builder: (context, snapshot) {
                ...
                RaisedButton(
                  onPressed: () async {
                    if (controller.name.trim().isEmpty) {
                      ...
                      return;
                        ...
                        ((await db.getAllMedicines).any((element) =>
                            element.name.trim() == controller.name))) {
                  ...
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10)),
                  child: Text(widget.medicine != null ? 'حفظ' : "إضافة",
