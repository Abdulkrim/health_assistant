...
class AnalysisDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(analysis.name.contains('تحليل')
            ? analysis.name
            : 'تحليل ${analysis.name}'),
        centerTitle: true,
      ),
          ...
          if (analysis.image != null)
            Container(
                ...
                child: GestureDetector(
                  ...
                  child: Image.memory(
                    File(analysis.image).readAsBytesSync(),
                    fit: BoxFit.cover,
                    frameBuilder:
                    ...
                    child: Column(
                      children: [
                        Expanded(
                            ...
                            child: Align(
                              alignment: Alignment(
                                  0.0, analysis.value == null ? 0.5 : 2.0),
                              child: Text(
                                analysis.value == null
                                    ? "لايوجد نتيجة"
                ...
                builder: (context, snapshot) {
                  ...
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Center(
                          child: Text('بإشراف الطبيب ${snapshot.data.name}')),
                    ),
                  );
                }),
